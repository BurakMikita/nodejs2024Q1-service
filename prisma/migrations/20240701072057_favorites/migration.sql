...
-- AlterTable
ALTER TABLE "Artist" ADD COLUMN     "favoritId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Artist" ADD CONSTRAINT "Artist_favoritId_fkey" FOREIGN KEY ("favoritId") REFERENCES "Favorites"("id") ON DELETE SET NULL ON UPDATE CASCADE;
